<div class="blog-post">
  <div style="background-image:url('{{ $post->image }}'); background-size:cover; padding: 350px 150px 0 0;">
    <div style="max-width:450px;" class="blog-container @if($i == 1)blog-container-even @else blog-container-odd @endif    ">
      ...
      <p class="blog-post-meta">{{ $post->created_at->toFormattedDateString() }} by {{ $post->name }}</p>
    </div>
  </div>
