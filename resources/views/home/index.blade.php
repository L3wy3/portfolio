...
<div id="parallax" class="keyart">
  <div id="para-box-1" class='keyart_layer parallax' data-speed='1' style="background-image: url('/img/background.jpg');height:200vh;position:fixed;top:0;width:100%;">
  ...
  <div id="para-box-2" class="keyart_layer parallax" data-speed="5"></div>
  <div id="para-box-3" class="keyart_layer parallax" data-speed="6"></div>
  <div id="para-box-4" class="keyart_layer parallax" data-speed="20">
  ...
  <div id="para-box-5" class="keyart_layer parallax" data-speed="20">
    <div style='background-color:blue'>
  ...
  <div id="para-box-6" class="keyart_layer parallax" data-speed="20">
  	<img src="./img/robin.png" style="postition:absolute; top:0;s">
  </div>
  <div id="para-box-7" class="keyart_layer parallax" data-speed="20">
